...
<div>
	...
	<div id="menubutton">
		<a class="btn btn-default glyphicon glyphicon-folder-open" href="#"
		   role="button"
		   style="margin-left: 10px; margin-top: 10px; width: 130px;" onclick="return buildfile()">&nbsp;新建文件夹</a>

		<div class="btn-group" role="group" id="operation" style="margin-left: 40px; margin-top: 10px;">
			<a class="btn btn-default" href="#" onclick="return share(this)">分享</a>
			<a class="btn btn-default" href="#" id="download" onclick="return downloadFileSelect(this)">下载</a>
			<a class="btn btn-default" href="#" id="delete" onclick="return deleteall()">删除</a>
		...
		<div class="input-group"
			 style="width: 200px; float: right; margin-right: 50px; margin-top: 10px; ">
			<input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" >
			<span class="input-group-addon glyphicon glyphicon-search" onclick="searchFile(this)"/>
		</div>
	</div>
</div>
<div class="panel panel-default" style="margin-left: 10px; margin-top: 10px">
	...
	<div class="panel-heading" id="pathnav">
		<a href="index.action" path="">${username} ></a>
		<span id="navPath">
